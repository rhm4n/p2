				...
				<div class="content-wrap">
					...
					<!-- Post Content
						...
						<div class="table-responsive">
							...
							<div align="center">
								<a href="<?php echo base_url()?>admin/setting/input_slideshow" class="button button-rounded button-reveal button-small button-border"><i class="icon-line-marquee-plus"></i><span>Tambah Slide</span></a>
							</div>
							...
							<table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
									...
									<tr>
										...
										<td><img height="40px" src="<?php echo $row->foto == null ? base_url().'assets/images/icons/preloader.gif' : base_url().$row->foto ; ?> "></td>
										<td>
											<a href="<?php echo base_url().'admin/setting/input_slideshow/'.$row->id ?>" class="button button-3d button-mini button-rounded button-reveal button-aqua"><i class="icon-pencil2"></i><span>Edit</span></a>
									...
									<div class="modal fade" id="del_<?php echo $row->id ?>" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
										<form method="POST" action="<?php echo base_url('admin/setting/del_slideshow/').$row->id ?>">
